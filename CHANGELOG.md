...
- Novo guia **[docs/mcp-modes.md](docs/mcp-modes.md)**: limites, `seeMoreOnSite`, base **`MCP_PUBLIC_BASE_URL`** (site canônico `https://www.meelion.com` vs host da API `mcp.meelion.com`).
...
- **docs/examples.md** e arquivo de exemplo JSON: notas de `limit` e `detailUrl` público.
