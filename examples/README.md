...
- **`get-future-projections.json`**: corpo JSON-RPC para `tools/call` → `get_future_projections` (expectativas Selic, DI, IPCA, câmbio; opcional `ano`/`year`). Ver [../docs/tools.md](../docs/tools.md#get_future_projections).
